-- Discord Rich Presence Script by Adib and Montri
-- Main Coding and Information by Adib (Adib Itsuki)
-- Testing and Functions by Montri
-- Contact Adib for any help or Suggestions or Bugs

script_name("GTA SA:MP Discord RPC")
script_author("Adib and Montri")
script_dependencies(
	"work-in-pause",
...
function calculateZoneEN(x, y, z)
    ...
    return 'Unknown, possibly in the interior'
end
...
-- RPC Texts --
	while true do
        ...
        if result then
            ...
            HOLD_PLAYERNAME = Playername
        end

-- Upper Text --
		local SRVip, SRVport = sampGetCurrentServerAddress()
		local SRVname = sampGetCurrentServerName()
		if (SRVip == "178.128.31.86") then
			discordRPC.shutdown()
		else
			if (SRVip == "213.32.6.232") then
				rpc.largeImageKey = "samp_icon"
				rpc.state = "" .. SRVip ..":"..SRVport ..""
				rpc.details = "Horizon Roleplay [hzgaming.net]"
			else
				rpc.largeImageKey = "samp_icon"
				rpc.state = "" .. SRVip ..":"..SRVport ..""
				rpc.details = "".. SRVname ..""
...
-- Large Image Hover Texts and Image (Name and Location) --
		...
		if isCharSittingInAnyCar(playerPed) then
            ...
            rpc.largeImageText = string.format("IGN: ".. HOLD_PLAYERNAME .." | near %s with %s", zone, getGxtText(gxtModel))
        else
            rpc.largeImageText = "IGN: " .. HOLD_PLAYERNAME .. " | near " .. zone
        end

-- Small Image Hover Texts and Image (Weapon Name) --
